...
browser = webdriver.Chrome(
    executable_path='/Users/huanxin/scraper/chromedriver')
...
f_in = csv.reader(open('foreclosure_random_sample_clean.csv', 'r'),
                  delimiter=',')
f_in.next()
f_out = csv.writer(open('sample_result_exact.csv', 'w'), delimiter=',',
                   dialect='excel')
new = True
cnt = 0
for i in f_in:
    ...
    print SSN, status, multi, options
    try:
        browser.find_element_by_xpath(
